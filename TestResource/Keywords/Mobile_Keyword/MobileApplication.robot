...
LoginAndSetupPinSimulator
    [Arguments]                                    ${data_test}
    ${reset}                                       mGetDevices                                                                                                                                                                                                                                                      ${devicesName}[2]                                                                        ${JsonfilePath}
    Run Keyword If                                 '${reset}' == 'false' or '${reset}' == 'False'                                                                                                                                                                                                                   CheckReset                                                                               ${data_test}
    ...                                            ELSE                                                                                                                                                                                                                                                             InputPasscode
...
ClickImportant
    AppiumLibrary.Wait Until Element Is Visible    ${TXT_LIFEMOBILE}
...
PayerInformationMobile
    ...
    WaitAndInput                                   xpath=//android.widget.EditText[@resource-id='com.tokiomarine.fasttrack.gb:id/occ_edittext_search']                                                                                                                                                              ${data_test['PayerInformation']['Occupation']}
    WaitAndClick                                   xpath=//android.widget.TextView[@resource-id='com.tokiomarine.fasttrack.gb:id/agm_list_item_code']
    WaitAndClick                                   ${TXT_SECTION2['${ENV}']}
...
PolicyMobile
    ...
    Run Keyword If                                 '${status}' == 'False'                                                                                                                                                                                                                                           AppiumLibrary.Click Element                                                              ${TXT_SECTION3}
    ...
    WaitAndClick                                   xpath=//android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View/android.view.View[1]/android.view.View/android.view.View[3]/android.widget.TextView[1]
    WaitAndClick                                   xpath=//android.view.View[1]/android.view.View/android.view.View[7]/android.widget.EditText
    Execute Adb Shell                              input text 100000
    Execute Adb Shell                              input tap 1300 1350
    sleep                                          10s
    AppiumLibrary.Swipe By Percent                 90                                                                                                                                                                                                                                                               40                                                                                       90                                                                                                                                                                                                                  0
    Refund                                         ${data_test}

Refund
    [Arguments]                                    ${data_test}
    WaitAndInput                                   xpath=//android.widget.EditText[@resource-id='Dividend_BankAccountHolderName']                                                                                                                                                                                   ${data_test['PayerInformation']['Name']}
    WaitAndInput                                   xpath=//android.widget.EditText[@resource-id='Dividend_BankAccountHolderLastName']                                                                                                                                                                               ${data_test['PayerInformation']['Lastname']}
    WaitAndClick                                   xpath=//android.view.View[2]/android.view.View[2]/android.view.View/android.view.View[4]/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.TextView
    ...
    # WaitAndInput                                   xpath=//android.widget.EditText[@resource-id='Dividend_BankBranch']
    ...
    WaitAndClick                                   xpath=//android.widget.EditText[@resource-id='Age']
...
QuestionnaireMobile
    ...
    WaitAndClick                                   xpath=//android.widget.EditText[@resource-id='Insured_Weight']
    Execute Adb Shell                              input text 60

    WaitAndClick                                   xpath=//android.widget.EditText[@resource-id='Insured_Height']
    Execute Adb Shell                              input text 170
