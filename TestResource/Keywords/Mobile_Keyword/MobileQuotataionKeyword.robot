...
MobileQuotation
    ...
    mGetDevices                                           ${devicesName}[0]                                             ${JsonfilePath}                                     ${AppPackage['${ENV}']}                                                                                                                                                                                            ${AppActivity}    false
    CheckPermission
...
CreateQuotationMobile
    VerifyText                                            ${TXT_TITLE_QUOTATION_MOBILE['${ENV}']}                       E-Quotation
...
ClickRadioFemale
    Execute Adb Shell                                     input tap 1200 1050
...
MobilePayerInformation
    ...
    AppiumLibrary.Wait Until Element Is Visible           ${TXT_NAME_MOBILE}                                            ${timeout}
